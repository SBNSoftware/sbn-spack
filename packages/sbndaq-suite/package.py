...
##insert-here
    ...
    with when("@v2_03_00"):
        ...
        depends_on("caendigitizer@2.17.3")
        #
        depends_on("wibtools@v2_03_00")
        depends_on("sbndaq-artdaq-core@v2_03_00")
        depends_on("sbndaq-artdaq@v2_03_00")
        depends_on("sbndaq@v2_03_00")
        depends_on("artdaq-runcontrol-gui@v1_03_06")
        depends_on("windriver@v16_06_00")
    ...
    with when("@v2_01_00"):
        ...
        depends_on("caendigitizer@2.17.3")
        #
        depends_on("wibtools@v2_01_00")
        depends_on("sbndaq-artdaq-core@v2_01_00")
        depends_on("sbndaq-artdaq@v2_01_00")
        depends_on("sbndaq@v2_01_00")
        depends_on("artdaq-runcontrol-gui@v1_03_06")
    ...
    with when("@v1_10_09"):
        ...
        depends_on("caendigitizer@2.17.3")
        #
        depends_on("wibtools@v1_10_09")
        depends_on("sbndaq-artdaq-core@v1_10_09")
        depends_on("sbndaq-artdaq@v1_10_09")
        depends_on("sbndaq@v1_10_09")
        depends_on("artdaq-runcontrol-gui@v1_03_06")
